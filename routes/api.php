...
Route::get('/checkRatingEligibility/{project_id}/{user_id}','ProjectRatingController@checkRatingEligibility');
Route::delete('/removeProjectRating/{project_id}/{user_id}','ProjectRatingController@removeProjectRating');
